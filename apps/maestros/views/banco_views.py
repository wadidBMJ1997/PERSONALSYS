...
class ConfigViews():
    ...
    fields_to_validate = [
        ('nombre_banco', 'nombre banco no puede estar vacio'),
        ('name_bank', 'name bank no puede estar vacio'),
    ]
...
class DataViewList():
	...
	table_headers = {
		'nombre banco': (2, 'nombre banco'),
        'name bank': (2, 'name bank'),
		'acciones': (2, 'Acciones'),
	}
     
	table_data = [
		{'field_name': 'nombre_banco', 'date_format': None},
        {'field_name': 'name_bank', 'date_format': None},
          
	]

# BancoListView - Inicio
