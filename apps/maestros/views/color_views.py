...
class DataViewList():
	...
	table_headers = {
		'nombre color ': (3, 'Nombre Color'),
		'acciones': (2, 'Acciones'),
	}
	
	table_data = [
		{'field_name': 'nombre_color', 'date_format': None},
	]

# ColorListView - Inicio
class ColorListView(MaestroListView):
...
# ColorCreateView - Inicio
class ColorCreateView(MaestroCreateView):
    model = ConfigViews.model
    list_view_name = ConfigViews.list_view_name
...
# ColorUpdateView
class ColorUpdateView(MaestroUpdateView):
    model = ConfigViews.model
    list_view_name = ConfigViews.list_view_name
    form_class = ConfigViews.form_class
    template_name = ConfigViews.template_form
...
# ColorDeleteView
class ColorDeleteView (MaestroDeleteView):
    model = ConfigViews.model
    list_view_name = ConfigViews.list_view_name
    form_class = ConfigViews.form_class
