...
class DataViewList():
	...
	table_headers = {
		'codigo_cliente': (3, 'Código'),
		'nombre_cliente': (4, 'Cliente'),
		'fecha_registro_cliente': (3, 'Fecha Reg.'),
		'opciones': (2, 'Opciones'),
	}
	
	table_data = [
		{'field_name': 'codigo_cliente', 'date_format': None},
		{'field_name': 'nombre_cliente', 'date_format': None},
		{'field_name': 'fecha_registro_cliente', 'date_format': 'd/m/Y'},
	]
